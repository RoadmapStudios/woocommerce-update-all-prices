			...
			for($k=0;$k<$len1;$k++) {
			  ...
			  $product_sub = $variable_subscription[$k];
               $prov_id = $product_sub->get_ID();
				...
				$variation_id = ''; $display_price = ''; $updated_price = ''; $signupfee = ''; $signupfee3 = ''; $available_variations = '';
                    ...
                    <table class="form-table">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input name="amount" type="text" id="amount" value="<?php echo isset($_POST['amount']) ? $_POST['amount'] : '0'; ?>" class="regular-text">%
                                </td>
                            </tr>
